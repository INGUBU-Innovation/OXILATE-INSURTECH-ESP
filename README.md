...
Figure 1 General workflow for NLP-based models to provide trends and insights in finance sector
...
Figure 2: Estimates of assets under management with an ESG mandate. Source: Deutsche Bank.
...
Figure 3: Templating with masked language models. [1]
